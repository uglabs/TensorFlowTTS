...
from ttsexamples.fastspeech2_cmukids.fastspeech2_dataset import (
...
def main():
    ...
    parser.add_argument(
        "--train-dir",
        default="dump_cmukids/train",
        type=str,
        help="directory including training data. ",
    )
    parser.add_argument(
        "--dev-dir",
        default="dump_cmukids/valid",
        type=str,
    ...
    parser.add_argument(
        "--f0-stat", default="./dump_cmukids/stats_f0.npy", type=str, help="f0-stat path.",
    )
    parser.add_argument(
        "--energy-stat",
        default="./dump_cmukids/stats_energy.npy",
        type=str,
    ...
    parser.add_argument(
        "--dataset_config", default="preprocess/cmukids_preprocess.yaml", type=str,
    )
    parser.add_argument(
        "--dataset_stats", default="dump_cmukids/stats.npy", type=str,
    )
    parser.add_argument(
        "--dataset_mapping", default="dump_cmukids/cmukids_mapper.npy", type=str,
    )
    parser.add_argument(
        "--pretrained",
        default="",
